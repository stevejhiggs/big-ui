...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Root>) {
  ...
  return <Label data-slot="form-label" data-error={!!error} className={cn('data-[error=true]:text-destructive-foreground', className)} htmlFor={formItemId} {...props} />;
}
...
function FormMessage({ className, ...props }: React.ComponentProps<'p'>) {
  ...
  return (
    <p data-slot="form-message" id={formMessageId} className={cn('text-destructive-foreground text-sm', className)} {...props}>
      {body}
    </p>
  );
}
